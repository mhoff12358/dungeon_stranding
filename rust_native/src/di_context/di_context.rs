...
pub struct DiContext {
    ...
    #[export]
    verbose_logging_name: GodotString,
...
impl DiContext {
    pub fn try_get_registered_node_template<T: GodotClass + Inherits<Node>>(
        ...
        self.try_get_registered_node_with_id(T::class_name().to_godot_string(), id)
            .map(|node| node.cast())
    }
    ...
    pub fn get_registered_node_template<T: GodotClass + Inherits<Node>>(
        ...
        if let Some(result) = self
            .try_get_registered_node_with_id(T::class_name().to_godot_string(), id.clone())
            .map(|node| node.cast())
        {
            result
        } else {
...
impl DiContext {
    #[func]
    pub fn try_get_registered_node(&self, type_name: GodotString) -> Option<Gd<Node>> {
        return self.try_get_registered_node_with_id(type_name, "".into());
    }

    #[func]
    pub fn get_registered_node(&self, type_name: GodotString) -> Gd<Node> {
    ...
    #[func]
    pub fn get_registered_node_with_id(&self, type_name: GodotString, id: GodotString) -> Gd<Node> {
